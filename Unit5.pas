...
begin
 zqry1.SQL.Clear;
  zqry1.SQL.Add('insert into pasien values(,"'+e1.Text+'","'+e2.Text+'","'+e3.Text+'","'+e4.Text+'")');
  zqry1.ExecSQL;

  zqry1.SQL.Clear;
  zqry1.SQL.Add('select * from pasien');
  zqry1.Open;
...
begin
 zqry1.Edit;
zqry1.FieldByName('id_pasien').Text:=e1.Text;
zqry1.FieldByName('nama').Text:=e2.Text;
zqry1.FieldByName('tanggal_lahir').Text:=e3.Text;
...
begin
 zqry1.SQL.Clear;
  zqry1.SQL.Add('DELETE FROM pasien WHERE 1');
  zqry1.ExecSQL;
