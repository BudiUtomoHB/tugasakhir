...
begin
 zqry1.SQL.Clear;
  zqry1.SQL.Add('insert into pemesanan values(,"'+e1.Text+'","'+e2.Text+'","'+e3.Text+'","'+e4.Text+'")');
  zqry1.ExecSQL;

  zqry1.SQL.Clear;
  zqry1.SQL.Add('select * from poliklinik');
  zqry1.Open;
...
begin
 zqry1.SQL.Clear;
  zqry1.SQL.Add('DELETE FROM poliklinik WHERE 1');
  zqry1.ExecSQL;
